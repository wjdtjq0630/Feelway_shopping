...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/top1.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">stone island</span><br>스톤아일랜드 맨투맨</h2></span>
              <span><b>158,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/top1-detail.PNG">
            <img src="product/top1-1.PNG">
            <img src="product/top1-2.PNG">
          </div>
    </main>
    <hr>
    <footer>
