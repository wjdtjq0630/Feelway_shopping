...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/outer2-detail3.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">nike</span><br>나이키 롱패딩</h2></span>
              <span><b>258,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/outer2-detail.PNG">
            <img src="product/outer2-detail2.PNG">
            <img src="product/outer2-detail3.PNG">
                    </div>
    </main>
    <hr>
    <footer>
