...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/outer8.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">channel</span><br>샤넬 패딩</h2></span>
              <span><b>1,095,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/outer8-detail.PNG">
            <img src="product/outer8.PNG">
            <img src="product/outer8-detail2.PNG">
                    </div>
    </main>
    <hr>
    <footer>
