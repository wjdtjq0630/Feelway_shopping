...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/bottom2-detail.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">dsquared2</span><br>디스퀘어드 트레이닝바지</h2></span>
              <span><b>239,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/bottom2-detail.PNG">
          </div>
    </main>
    <hr>
    <footer>
