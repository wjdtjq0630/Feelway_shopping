...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/outer1.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">moose knuckles</span><br>무스너클 패딩 자켓</h2></span>
              <span><b>438,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/outer1-detail.PNG">
            <img src="product/outer1-detail2.PNG">
            <img src="product/outer1-1.PNG">
            <img src="product/outer1-2.PNG">
            <img src="product/outer1-3.PNG">
            <img src="product/outer1-4.PNG">
          </div>
    </main>
    <hr>
    <footer>
