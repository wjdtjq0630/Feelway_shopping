...
%>
            ...
            <ul>
          	...
          	<%
          		if(check==null){
          			...
          			out.println("<a href='mypage.jsp'>마이페이지</a>");
    ...
    <main>
      <div class="item_img">
          <img src="product/bottom1-1.PNG" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">dsquared2</span><br>디스퀘어드 청바지</h2></span>
              <span><b>268,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/bottom1-detail.PNG">
            <img src="product/bottom1-detail2.PNG">
            <img src="product/bottom1-1.PNG">
          </div>
    </main>
    <hr>
    <footer>
