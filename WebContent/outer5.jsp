...
%>
    ...
    <main>
      <div class="item_img">
          <img src="product/outer5.png" class="productimg">
          </div>
          <div class="item_info">
            <span><h2><span class="brandname">moose knuckles</span><br>무스너클 후드집업</h2></span>
              <span><b>395,000</b>원</span><br><hr>
          ...
          <div class="item_detail">
            ...
            <img src="product/outer5-detail.PNG">
            <img src="product/outer5-detail2.PNG">
                    </div>
    </main>
    <hr>
    <footer>
